...
func (_m *MockRepository) CreateCompetition(name string, competitionType string, externalEntityId *string) (*models.Competition, error) {
...
func (_mr *_MockRepositoryRecorder) CreateCompetition(arg0, arg1, arg2 interface{}) *gomock.Call {
...
func (_m *MockrealWorldRepository) CreateCompetition(name string, competitionType string, externalEntityId *string) (*models.Competition, error) {
	ret := _m.ctrl.Call(_m, "CreateCompetition", name, competitionType, externalEntityId)
	ret0, _ := ret[0].(*models.Competition)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
func (_mr *_MockrealWorldRepositoryRecorder) CreateCompetition(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateCompetition", arg0, arg1, arg2)
}
