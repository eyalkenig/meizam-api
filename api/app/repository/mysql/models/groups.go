...
var GroupWhere = struct {
	...
	IsPublic:  whereHelpernull_Bool{field: `is_public`},
...
var (
	groupColumns               = []string{"id", "name", "password", "is_public", "created_at", "updated_at"}
	groupColumnsWithoutDefault = []string{"name", "password", "is_public", "created_at", "updated_at"}
