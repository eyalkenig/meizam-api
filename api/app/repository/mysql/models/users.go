...
var UserWhere = struct {
	...
	DisplayName: whereHelperstring{field: `display_name`},
...
var (
	userColumns               = []string{"id", "name", "display_name", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "display_name", "created_at", "updated_at"}
